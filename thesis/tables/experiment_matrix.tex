...
\midrule
Observation ablation (forward) & Path following & state, lidar, BEV & Fixed-speed trailer mean abs.\ CTE, max $|\gamma|$, completion \\
Observation ablation (reverse) & Reverse tracking & state, lidar, BEV & Fixed-speed trailer mean abs.\ CTE, max $|\gamma|$, jackknife rate \\
