...
\begin{itemize}
    ...
    \item \textbf{Task-specific action constraints}: Separating fixed-speed path-tracking experiments from variable-speed obstacle-navigation experiments in the implementation, so that the thesis benchmark and the codebase enforce the same problem definition.
