% Scalable Simulation. Kept in its own file and \input at the end of chapter 3
% (see chapters/03_modeling_simulation_problem.tex), where the batched simulator
% reads as a contribution of the modeling-and-simulation chapter rather than as
% infrastructure buried in the learning chapter.
%
% Cross-references name the learning chapter or a specific section, since this
% text no longer sits in the same chapter as the experiments it supports.
