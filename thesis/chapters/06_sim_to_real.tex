...
In laboratory operation the infrastructure nodes recover the region directly behind the trailer that the onboard LiDAR cannot observe, extending obstacle coverage to [TODO]\% of the vehicle's immediate surroundings during reverse maneuveres, at an added end-to-end latency of [TODO]\,ms relative to onboard-only perception.
