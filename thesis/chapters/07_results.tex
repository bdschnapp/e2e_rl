...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/experiment_results/forward_obs_ablation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/experiment_results/reverse_obs_ablation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/experiment_results/forward_reward_ablation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/experiment_results/reverse_reward_ablation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/experiment_results/failure_replay_curve}
