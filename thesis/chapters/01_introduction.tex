...
This thesis extends the ME~780 foundational work by:

\begin{itemize}
    \item developing a full kinematic and dynamic model of a tractor-trailer system including hitch instability analysis;
    \item designing a vision-based RL observation space using CNN encoders and autoencoders operating on bird's-eye-view (BEV) occupancy grids;
    ...
    \item implementing and benchmarking DDPG and Decision Transformer agents against PID and NMPC baselines across forward, reverse, and obstacle-avoidance tasks;
    \item validating the trained policies in the Gazebo simulation environment and transferring to the Agilex hardware platform via ROS2 and Autoware.
\end{itemize}
...
Validation       & Both simulation (Gazebo) and hardware (Agilex) empirical evidence \\
