\chapter{Modelling, Simulation, and Problem Formulation}
...
\begin{enumerate}
    ...
    \item \textbf{Obstacle Placement and Local Re-planning}: Randomly placed static obstacles within the lane and a local path planner that perturbs the centreline around those obstacles for avoidance experiments.
